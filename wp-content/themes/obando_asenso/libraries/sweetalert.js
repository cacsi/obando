! function (t, e) {
	...
	var wt = {
		...
		kt = function (t) {
			if (!Bt[t.input]) return v('Unexpected type of input! Expected "text", "username", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'.concat(t.input, '"'));
			var e = At(t.input),
				n = Bt[t.input](e, t);
		...
		Bt = {};
	Bt.text = Bt.username = Bt.password = Bt.number = Bt.tel = Bt.url = function (t, e) {
	...
	function Tt(t, e) {
		...
		e ? (rt(e, c), X(c, "block")) : e.text ? (c.textContent = e.text, X(c, "block")) : G(c), n = t, o = e, i = k(), r = wt.innerParams.get(n), a = !r || o.input !== r.input, Ct.forEach(function (t) {
			var e = _[t],
				n = lt(i, e);
	...
	var ue = function () {
		...
		le = {
			username: function (t, e) {
				return /^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]{2,24}$/.test(t) ? Promise.resolve() : Promise.resolve(e || "Invalid username address")
			},
			url: function (t, e) {
	...
	function me(t, e) {
		"select" === e.input || "radio" === e.input ? Te(t, e) : -1 !== ["text", "username", "number", "tel", "textarea"].indexOf(e.input) && g(e.inputValue) && Ee(t, e)
	}
