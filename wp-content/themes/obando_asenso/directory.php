...
<?php get_header(); ?>
<?php $directorydata = get_field('directorydata');?>

<?php $directorydata2 = get_field('directorydata2');?>
            ...
            <div class="img-date">
                <!--  -->
                    ...
                    <div class="content-news">
                        <div class="twotableflex">

                            <div class="one-direct">

                                   <?php echo $directorydata; ?>
                            ...
                            <div class="two-direct">

                                <?php echo $directorydata2; ?>
